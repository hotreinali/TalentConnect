...
import login_img from "../assets/login_bg.jpg";
...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      navigate(role === "Employer" ? "/post-job" : "/job-search");
    } catch (error) {
  ...
  return (
    <section className="h-screen flex justify-center items-center">
      <div className="z-10 h-[80%] w-[90%] max-w-5xl flex shadow-lg rounded-lg">
        ...
        <div className="w-full md:w-1/2 bg-white flex flex-col items-center justify-start gap-5 mt-0 h-full overflow-auto">
